...
export const PdfDocumentPreview: React.FC<PdfDocumentPreviewProps> = ({ data, isPrintMode = false }) => {
  ...
  // --- SCREEN PREVIEW MODE ---
  return (
    <div className="h-full overflow-y-auto bg-slate-200/80 dark:bg-slate-950/80 p-3 sm:p-5 flex justify-center selection:bg-indigo-100 transition-colors">
      {/* The 1-Page Letter Sheet (Authentic Jake's Resume Spacing) */}
      <div
        id="printable-resume"
        className="bg-white text-slate-900 shadow-xl rounded-sm w-full max-w-[720px] p-6 sm:p-8 font-serif leading-normal selection:bg-indigo-100"
